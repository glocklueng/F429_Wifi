...
const u8* remote_ip = "192.168.191.1";	
//const u8* remote_ip = "222.212.204.66";	

const u8* portnum   = "8086";	 

//WIFI STA模式,设置要去连接的路由器无线参数,请根据你自己的路由器设置,自行修改.
const u8* wifista_ssid="Growl";			//路由器SSID号
const u8* wifista_encryption="wpawpa2_aes";	//wpa/wpa2 aes加密方式
const u8* wifista_password="147258369"; 	//连接密码
...
void atk_8266_init(void)
{
	...
	sprintf((char*)p,"AT+CIPSTART=\"TCP\",\"%s\",%s",remote_ip,(u8*)portnum);    //配置目标TCP服务器
